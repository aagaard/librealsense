...
cmake ../ -DFORCE_LIBUVC=true -DCMAKE_BUILD_TYPE=release -DTRACE_API=true -DBUILD_PYTHON_BINDINGS=true -DBUILD_GRAPHICAL_EXAMPLES=false -DBUILD_EXAMPLES=false -DPYTHON_EXECUTABLE:FILEPATH=/home/scio/archiconda3/envs/realsense/bin/python
make -j2
sudo make install
